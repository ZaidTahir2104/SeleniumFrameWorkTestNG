...
public class ExtentReportHTML {
	...
	public void setExtent(){
		extent = new ExtentReports(System.getProperty("user.dir") + "/test-output/BallogyTesting.html");
		extent.addSystemInfo("Host Name", "Zaid");
		extent.addSystemInfo("User Name", "Tahir Automation Labs");
	...
	public void tearDown(ITestResult result) throws IOException{
		...
		if(result.getStatus()==ITestResult.FAILURE){
			...
			String screenshotPath = ExtentReportHTML.getScreenshot(driver, result.getName());
